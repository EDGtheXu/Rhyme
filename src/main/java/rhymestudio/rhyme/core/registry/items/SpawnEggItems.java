...
public class SpawnEggItems{
    ...
    public static final DeferredItem<Item> POLE_VAULTING_ZOMBIE_EGG = register("pole_vaulting_zombie_egg", "撑杆跳僵尸刷怪蛋", Zombies.POLE_VAULTING_ZOMBIE,0x216853,0xA0522D);
