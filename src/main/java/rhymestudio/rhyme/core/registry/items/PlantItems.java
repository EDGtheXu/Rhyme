...
public class PlantItems {
    ...
    public static final RegistryObject<Item> SNOW_PEA_ITEM = registerPlant("snow_pea_shooter", "寒冰射手", ()-> builder(PlantEntities.SNOW_PEA,175).build());
    public static final RegistryObject<Item> REPEATER_ITEM = registerPlant("repeater","双重射手", ()-> builder(PlantEntities.REPEATER,200).build());
