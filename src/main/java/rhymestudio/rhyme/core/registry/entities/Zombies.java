...
public class Zombies {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<PoleVaultingZombie>> POLE_VAULTING_ZOMBIE = registerMonster("pole_vaulting_zombie", "撑杆僵尸", (e, l)->new PoleVaultingZombie(e,l,LandMonsterPrefab.CONE_ZOMBIE_PREFAB.get()),0.6F,1.95F);
