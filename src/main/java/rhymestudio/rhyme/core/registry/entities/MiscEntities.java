...
public class MiscEntities {
    ...
    public static final RegistryObject<EntityType<LineProj>> SNOW_PEA_PROJ = registerMisc("snow_pea_proj",(e, l)->
            new LineProj(e,l,BaseProj.TextureLib.SNOW_PEA, new MobEffectInstance(ModEffects.SLOWDOWN_EFFECT.get(),20 * 5)).setHitSound(ModSounds.SNOW_PROJ_HIT),0.25F,0.25F);

    public static final RegistryObject<EntityType<LineProj>> FROZEN_PEA_PROJ_1 = registerMisc("frozen_pea_proj_1",(e, l)->
            new LineProj(
                    e, l,
                    BaseProj.TextureLib.SNOW_PEA,
                    List.of(new MobEffectInstance(ModEffects.FROZEN_EFFECT.get(), 20 * 2), new MobEffectInstance(ModEffects.SLOWDOWN_EFFECT.get(),20 * 5)
                    )
            ).setHitSound(ModSounds.SNOW_PROJ_HIT),0.25F,0.25F);

    public static final RegistryObject<EntityType<LineProj>> FROZEN_PEA_PROJ_2 = registerMisc("frozen_pea_proj_2",(e, l)->
            new LineProj(
                    e, l,
                    BaseProj.TextureLib.SNOW_PEA,
                    List.of(new MobEffectInstance(ModEffects.FROZEN_EFFECT.get(),20 * 5), new MobEffectInstance(ModEffects.SLOWDOWN_EFFECT.get(),20 * 5)
                    )
    ...
    public static final RegistryObject<EntityType<LineProj>> FUME_SHROOM_PROJ = registerMisc("fume_shroom_proj",(e,l)->
    ...
    public static final RegistryObject<EntityType<LineProj>> BLEED_FUME_SHROOM_PROJ_1 = registerMisc("bleed_fume_shroom_proj_1",(e,l)->
            new LineProj(e,l,BaseProj.TextureLib.EMPTY,List.of(new MobEffectInstance(ModEffects.BLEED_EFFECT.get(),20*5,0))).setExistTick(10).setPenetrate(99).setHitSound(ModSounds.SPLAT).setClientTickCallback(p->{
                for(int i=0;i<5;i++)
                    p.level().addParticle(ModParticles.PUFF_PROJ_PARTICLE.get(),p.getX(),p.getY()+0.5,p.getZ(),0.0D,0,0);
            }), 1F,1F);

    public static final RegistryObject<EntityType<LineProj>> BLEED_FUME_SHROOM_PROJ_2 = registerMisc("bleed_fume_shroom_proj_2",(e,l)->
            new LineProj(e,l,BaseProj.TextureLib.EMPTY,List.of(new MobEffectInstance(ModEffects.BLEED_EFFECT.get(),20*5,1), new MobEffectInstance(ModEffects.SLOWDOWN_EFFECT.get(), 20*3))).setExistTick(10).setPenetrate(99).setHitSound(ModSounds.SPLAT).setClientTickCallback(p->{
                for(int i=0;i<5;i++)
                    p.level().addParticle(ModParticles.PUFF_PROJ_PARTICLE.get(),p.getX(),p.getY()+0.5,p.getZ(),0.0D,0,0);
            }), 1F,1F);

    public static final RegistryObject<EntityType<LineProj>> BLEED_FUME_SHROOM_PROJ_3 = registerMisc("bleed_fume_shroom_proj_3",(e,l)->
            new LineProj(e,l,BaseProj.TextureLib.EMPTY,List.of(new MobEffectInstance(ModEffects.BLEED_EFFECT.get(),20*8,1), new MobEffectInstance(ModEffects.SLOWDOWN_EFFECT.get(), 20*5))).setExistTick(20).setPenetrate(99).setHitSound(ModSounds.SPLAT).setClientTickCallback(p->{
                for(int i=0;i<5;i++)
                    p.level().addParticle(ModParticles.PUFF_PROJ_PARTICLE.get(),p.getX(),p.getY()+0.5,p.getZ(),0.0D,0,0);
            }), 1F,1F);

    public static final RegistryObject<EntityType<LineProj>> BLEED_FUME_SHROOM_PROJ_4 = registerMisc("bleed_fume_shroom_proj_4",(e,l)->
            new LineProj(e,l,BaseProj.TextureLib.EMPTY,List.of(new MobEffectInstance(ModEffects.BLEED_EFFECT.get(),20*8,2), new MobEffectInstance(ModEffects.SLOWDOWN_EFFECT.get(), 20*6))).setExistTick(20).setPenetrate(99).setHitSound(ModSounds.SPLAT).setClientTickCallback(p->{
                for(int i=0;i<5;i++)
                    p.level().addParticle(ModParticles.PUFF_PROJ_PARTICLE.get(),p.getX(),p.getY()+0.5,p.getZ(),0.0D,0,0);
            }), 1F,1F);
