...
public class CrazyDave extends PathfinderMob implements GeoEntity {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 0.5f, Ingredient.of(ModTags.Items.DAVE_FOOD), false));
    ...
    public void die(DamageSource damageSource) {
        ...
        ItemEntity gold_coin = new ItemEntity(level(), this.getX(), this.getY(), this.getZ(), MaterialItems.GOLD_COIN.get().getDefaultInstance());
        ItemEntity silver_coin = new ItemEntity(level(), this.getX(), this.getY(), this.getZ(), MaterialItems.SILVER_COIN.get().getDefaultInstance());
