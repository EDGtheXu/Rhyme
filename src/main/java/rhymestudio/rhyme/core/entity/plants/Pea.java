...
public class Pea extends AbstractPlant<Pea> {
    ...
    public void addSkills() {
        //tip                                                  idle持续时间        触发攻击时间
        CircleMobSkill<Pea> idle = new CircleMobSkill<Pea>( "idle",  999999999, builder.attackInternalTick).
                onTick(a-> {
        ...
        // tip                                                攻击持续时间        射击触发时间
        CircleMobSkill<Pea> shoot = new CircleMobSkill<Pea>( "shoot", builder.attackAnimTick, builder.attackTriggerTick)
                .onTick(a->{
