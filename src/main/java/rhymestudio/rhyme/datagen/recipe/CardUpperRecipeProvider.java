...
public class CardUpperRecipeProvider extends AbstractRecipeProvider {
    ...
    protected class Builder {
        ...
        private final int defaultDamageArray[] = {10, 15, 20, 25, 30};
        ...
        public Builder(DeferredItem<? extends Item> result, int level) {
            ...
            if (level > 0 && level < this.defaultDamageArray.length) {
                this.damage = this.defaultDamageArray[level];
            }
            else {
                this.damage = this.defaultDamageArray[0];
            }
        }
