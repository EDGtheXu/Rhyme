...
public class ServerConfig {
    ...
    public static ModConfigSpec.ConfigValue<Integer> PlantConsumeAdditionStep  = BUILDER.comment("plant consume addition every step").define("plant_consume_addition_step", 1);
